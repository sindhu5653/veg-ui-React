    ...
    <div>
      <div className='relative'>
        <img
          ...
          src="https://images.unsplash.com/photo-1582562323010-707c59fc20ea?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mzd8fGZydWl0cyUyMGNvdmVyJTIwaW1hZ2VzfGVufDB8fDB8fHww"
          alt="about image1" />
        <h1 className='absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-white text-6xl font-bold px-4 py-2'>Contact US</h1>
      </div>
